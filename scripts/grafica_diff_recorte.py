...
DIR_COMPLETA = Path(r'C:\Users\migue\Desktop\training_afm\data\diff\npy')

# Diffs recortados 80x80 al Target Area — salida de npy_multicanal.py
# copiada como entrada de AFM_PredictiveModel
DIR_RECORTE  = Path(r'C:\Users\migue\Desktop\training_afm\Resultados\numpy_recortes\diff')

OUT_DIR = Path(r'C:\Users\migue\Desktop\training_afm\Resultados\registro')
